                ...
                <div class="block-area" id="input-masking">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-b-15">
                            ...
                            <input type="text" class="input-sm form-control " value="<?= $servicio['titulo'] ?>"  name="info[titulo]" placeholder="Titulo" required >
                        </div>

                        <div class="col-md-12 m-b-15">
                            <label>Descripción corta:</label>
                            <input type="text" class="input-sm form-control " value="<?= $servicio['descripcion'] ?>"  name="info[descripcion]" placeholder="Descripción" required >
                        </div>
                        ...
                        <div class="col-md-4 m-b-15">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-preview thumbnail form-control"style="max-width: 170px; max-height: 170px;" ><?= ($servicio['imagen']!= '')?'<img src="'.base_url().'uploads/servicios/s'.$servicio['imagen'].'" />':'' ?></div>
                        ...
                        <div class="col-md-12 m-b-15">
                            ...
                            <textarea  placeholder="Servicio:" name="info[contenido]" class='span12 ckeditor'  id="ck" ><?= $servicio['contenido'] ?></textarea>
                        </div>
