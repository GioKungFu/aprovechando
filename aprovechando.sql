...
--
-- Servidor: localhost
-- Tiempo de generación: 29-10-2015 a las 13:31:46
...
CREATE TABLE `productos` (
  ...
  `estado` enum('Activo','Inactivo','Destacado') NOT NULL DEFAULT 'Inactivo',
...
(1, 7, 1, 'Nuevo Moto E Segunda Generación', 'Un potente procesador Quad-core con 4G y la versión más reciente de Android™ OS, Lollipop. Por no hablar de la duración de la batería, que aguanta todo el día, para que pueda seguir tu ritmo.', '', '', 360000, 0, '', '', 1, 0, 'Android', '3 Mpx', '3G', 'Inactivo', '2015-10-29', '2015-10-29');
...
(11, 0, '2a22e92009e3e96cb7bc43d94e75c9dc.jpg'),
(12, 1, 'ac0d786a1f8afb99e9851a76dc6e3435.jpg'),
...
(1, 'luiceron@hotmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Administrador', 'Activo');
